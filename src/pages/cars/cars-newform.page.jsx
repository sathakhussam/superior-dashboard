...
const CarNewForm = (props) => {
  ...
  const myLastchance = async (thevartopass) => {
    try {
      ...
      const res = await API.patch("cars/", fd, {
        headers: {
  ...
  const customSubmit = async (e) => {
    ...
    LastVar["relatedVideos"] = [
      LastVar["relatedVideos1"],
      LastVar["relatedVideos2"],
      LastVar["relatedVideos3"],
    ];
      ...
      <Card>
        ...
        >
          ...
          <input
            type="text"
            name="carName"
            onChange={myForm.handleInputChange}
            value={myForm.inputs.carName}
            required
          ...
          <input
            ...
            name="description"
            onChange={myForm.handleInputChange}
            value={myForm.inputs.description}
            required
          ...
          <input
            ...
            name="KMIncluded"
            onChange={myForm.handleInputChange}
            value={myForm.inputs.KMIncluded}
            required
          ...
          <input
            ...
            name="hourlyRate"
            onChange={myForm.handleInputChange}
            value={myForm.inputs.hourlyRate}
            required
          ...
          <input
            ...
            name="perDayRate"
            onChange={myForm.handleInputChange}
            value={myForm.inputs.perDayRate}
            required
          ...
          <input
            ...
            name="preDeposit"
            onChange={myForm.handleInputChange}
            value={myForm.inputs.preDeposit}
            required
            placeholder="Pre Deposit"
          />
          <input
            type="text"
            name="contact"
            onChange={myForm.handleInputChange}
            value={myForm.inputs.contact}
            required
          ...
          <input
            ...
            name="whatsappNumber"
            onChange={myForm.handleInputChange}
            value={myForm.inputs.whatsappNumber}
            required
            placeholder="Whatsapp Number"
          />
          <select
            name="type"
            value={myForm.inputs.type}
            onChange={myForm.handleInputChange}
            id=""
          >
          ...
          <input
            ...
            name="relatedVideos1"
            onChange={myForm.handleInputChange}
            value={myForm.inputs.relatedVideos1}
            placeholder="Related Videos 1"
          />
          <input
            type="text"
            name="relatedVideos2"
            onChange={myForm.handleInputChange}
            value={myForm.inputs.relatedVideos2}
            placeholder="Related Videos 2"
          />
          <input
            type="text"
            name="relatedVideos3"
            onChange={myForm.handleInputChange}
            value={myForm.inputs.relatedVideos3}
            placeholder="Related Videos 3"
          />
